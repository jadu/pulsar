...
* Fixed issue where attributes with empty values (like `checked=""`) were still included in the markup. As much as I’m an optimist, having all checkboxes checked all the time wasn't ideal
