...
function createFilterListButton ($filterbar) {
    ...
    $addFilterButton = $('<button class="btn filter-bar__add" data-ui="show-filter-list" data-toggle="popover" data-trigger="click" title="Filter by" data-html="true" data-placement="bottom" data-content="" aria-haspopup="true" aria-expanded="false"><i class="icon-plus"><span class="hide">Add</span></i></button>');
