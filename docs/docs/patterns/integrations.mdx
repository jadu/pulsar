...
![Screenshot showing integrations hub example](/img/one.png)
...
<div className="d-example">
  <div className="media">
    <img src={require('@site/static/img/office365.png').default} alt="Office365 logo" className="media__image" />
...
<div className="d-guidelines">
  <div className="d-guidelines__block d-guidelines__block--do">
    ...
    <div className="d-guidelines-label">
      <em className="d-guidelines-label__title">Do</em> use title case, unless branding guidelines doctate otherwise (like YouTube)
    </div>
  </div>
  ...
  <div className="d-guidelines__block d-guidelines__block--not">
    ...
    <div className="d-guidelines-label">
      <em className="d-guidelines-label__title">Don’t</em> use a trailing full stop
    </div>
  </div>
</div>
...
![Screenshot showing the layout of an integration](/img/two.png)
    ...
    <div className="d-guidelines-preview">
      ...
      <div className="form__group form__group--full form__group--toggle">
        <label className="toggle-switch-wrapper-label" htmlFor="guid-1181820002">
          <span className="control__label">Enable integration</span>
          <span className="controls">
            <input id="guid-1181820002" name="toggle2" type="checkbox" className="form__control toggle-switch" defaultChecked />
            <span className="toggle-switch-label"></span>
          </span>
        </label>
      </div>
    ...
    <div className="d-guidelines-preview">
      ...
      <div className="form__group form__group--full form__group--toggle">
        <label className="toggle-switch-wrapper-label" htmlFor="guid-1181820004">
          ...
          <span className="controls">
            <input id="guid-1181820004" name="toggle4" type="checkbox" className="form__control toggle-switch" defaultChecked />
            <span className="toggle-switch-label"></span>
          </span>
        </label>
      </div>
...
![Screenshot showing the layout of a tabbed integration](/img/three.png)
