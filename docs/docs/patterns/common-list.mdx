...
Refer to the [DataTable set initial column order documentation](/components/datatable#set-initial-column-order) for specific information on how to define the column sort.
...
If a column needs to display the status of a boolean value, such as whether an item is live/offline, or visible/invisible, you can use [status icons](/components/status) to display this information.
