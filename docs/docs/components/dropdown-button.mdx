...
<div className="d-example">
  <div className="btn__group dropdown">
    <button aria-haspopup="true" aria-expanded="false" aria-controls="guid-1762003808" data-toggle="dropdown" className="btn dropdown__toggle">My Action&nbsp;<span className="caret"></span></button>
    <ul id="guid-1762003808" className="dropdown__menu pull-left">
      <li><a href="#foo">Foo</a></li>
