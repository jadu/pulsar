...
Refer to the [Jadu Accessibility Guidelines (internal)](http://accessibility-guide.ntn.jadu.net/components/tables/) for detailed guidance on the accessibility requirements of this component.
