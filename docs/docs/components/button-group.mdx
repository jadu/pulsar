...
<div className="d-example">
  <div className="btn__group">
    <button className="btn"><i className="icon-align-left"><span className="hide">Text align: left</span></i></button>
    <button className="btn"><i className="icon-align-center"><span className="hide">Text align: center</span></i></button>
    <button className="btn"><i className="icon-align-right"><span className="hide">Text align: right</span></i></button>
    <button className="btn"><i className="icon-align-justify"><span className="hide">Text align: justify</span></i></button>
  </div>
</div>
