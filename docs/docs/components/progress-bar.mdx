...
<div className="d-example">
  <div className="progress">
    <div aria-label="File upload progress" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style={{'width': '75%'}} className="progress-bar progress-bar--danger"
    ><span className="hide">75%</span> Upload failed <i aria-hidden="true" className="icon-warning-sign"></i></div>
  </div>
</div>
