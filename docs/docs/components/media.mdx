...
<div className="d-example">
  <div className="media">
    <i style={{color: '#e52d27'}} aria-hidden="true" className="icon-youtube media__image"></i>
    <div className="media__body">
      <p>YouTube</p>
...
<div className="d-example">
<div className="media">
  <i style={{color: '#0084b4'}} aria-hidden="true" className="icon-twitter media__image"></i>
  <div className="media__body">
