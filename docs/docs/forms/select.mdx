...
<div className="d-example">
  <div className="form__group">
    <label htmlFor="guid-1609313126" className="control__label">Pick a colour</label>
...
<div className="d-example">
  <div className="form__group">
    <label htmlFor="guid-1723390467" className="control__label">Pick a colour</label>
    <div className="controls">
      <select id="guid-1723390467" className="form__control select" defaultValue={'colour_blue'}>
        <option value="">Choose</option>
        <option value="colour_red">Red</option>
        <option value="colour_blue">Blue</option>
      </select>
...
<div className="d-example">
  <div className="form__group">
    <label htmlFor="guid-895788692" className="control__label">Pick colours</label>
    <div className="controls">
      <select id="guid-895788692" multiple className="form__control select" defaultValue={['colour_red', 'colour_blue']}>
        <option value="">Choose</option>
        <option value="colour_red">Red</option>
        <option value="colour_blue">Blue</option>
      </select>
...
<div className="d-example">
  <div className="form__group">
    <label htmlFor="guid-1473191617" className="control__label">Pick a colour</label>
    <div className="controls">
...
<div className="d-example">
  <div className="form__group">
    <label htmlFor="guid-260727864" className="control__label">My label</label>
    <div className="controls">
