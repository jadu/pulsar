...
<div className="d-example">
  <div className="form__group form__group--toggle">
    <label className="toggle-switch-wrapper-label" for="guid-69562041">
      <span className="control__label">Checked toggle</span>
      <span className="controls">
        <input checked id="guid-69562041" name="toggle-checked" type="checkbox" className="form__control toggle-switch" />
...
<div className="d-guidelines">
  ...
  <div className="d-guidelines-preview">
    <div class="form__group form__group--toggle">
      <label class="toggle-switch-wrapper-label" for="guid-1105218033">
        <span class="control__label">Enable integration</span>
        <span class="controls">
          <input id="guid-1105218033" name="toggle-a1" type="checkbox" class="form__control toggle-switch" />
          <span class="toggle-switch-label"></span>
        </span>
      </label>
    </div>
    <div class="form__group form__group--toggle">
      <label class="toggle-switch-wrapper-label" for="guid-13936864">
        <span class="control__label">Enable integration</span>
        <span class="controls">
          <input id="guid-13936864" name="toggle-a2" checked="checked" type="checkbox" class="form__control toggle-switch" />
          <span class="toggle-switch-label"></span>
        </span>
      </label>
    </div>
  ...
  <div className="d-guidelines__block d-guidelines__block--not">
    <div className="d-guidelines-preview">
      <div class="form__group form__group--toggle">
      <label class="toggle-switch-wrapper-label" for="guid-1105218031">
        <span class="control__label">Enable integration</span>
        <span class="controls">
          <input id="guid-1105218033" name="toggle-a3" type="checkbox" class="form__control toggle-switch" />
          <span class="toggle-switch-label"></span>
        </span>
      </label>
    </div>
    <div class="form__group form__group--toggle">
      <label class="toggle-switch-wrapper-label" for="guid-13936862">
        <span class="control__label">Disable integration</span>
        <span class="controls">
          <input id="guid-13936864" name="toggle-a4" checked="checked" type="checkbox" class="form__control toggle-switch" />
          <span class="toggle-switch-label"></span>
        </span>
      </label>
    </div>
...
<div className="d-guidelines">
  <div className="d-guidelines__block d-guidelines__block--do">
    <div className="d-guidelines-preview">
      <div class="form__group form__group--toggle"><label class="toggle-switch-wrapper-label" for="guid-270343646"><span class="control__label">Enable integration</span><span class="controls"><input id="guid-270343646" name="toggle-2" checked="checked" type="checkbox" class="form__control toggle-switch" /><span class="toggle-switch-label"></span><span class="help-block">Disabling will prevent customers from making card payments on your site</span></span></label></div>
    </div>
  ...
  <div className="d-guidelines__block d-guidelines__block--not">
    <div className="d-guidelines-preview">
      <div class="form__group form__group--toggle"><label class="toggle-switch-wrapper-label" for="guid-1337703768"><span class="control__label">Disable integration</span><span class="controls"><input id="guid-1337703768" name="toggle-2" checked="checked" type="checkbox" class="form__control toggle-switch" /><span class="toggle-switch-label"></span><span class="help-block">Card payments are enabled</span></span></label></div>
    </div>
