...
<div className="d-example">
  <div className="form__group">
    <label for="date-1" className="control__label">Start date</label>
...
<div className="d-example">
  <div className="form__group">
    <label for="date-2" className="control__label">Start date</label>
    <div className="controls">
      <div className="input-group has-btn-appended">
...
```html
<div class="form__group">
  <label for="date-2" class="control__label">Start date</label>
  <div class="controls">
    <div class="input-group has-btn-appended">
