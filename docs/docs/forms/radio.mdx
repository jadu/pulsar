...
<div className="d-example">
  ...
  <div className="form__group form-radio">
    <label htmlFor="guid-1739828169" className="control__label">My label</label>
...
<div className="d-example">
  <div className="form__group form-radio-inline">
    <div className="controls">
      <label htmlFor="guid-762536768" className="control__label"><input id="guid-762536768" name="radio-3" type="radio" className="form__control radio" />Standard left aligned</label>
    </div>
  </div>

  <div className="form__group form-radio-inline">
    <div className="controls">
      <label htmlFor="guid-2127935184" className="control__label">Right aligned<input id="guid-2127935184" name="radio-4" type="radio" className="form__control radio" /></label>
    </div>
  </div>
</div>
...
<div className="d-example">
  <div className="form__group form-radio-inline">
    <div className="controls">
      <label htmlFor="guid-619464244" className="control__label">
  ...
  <div className="form__group form-radio-inline form__group--indent">
    <div className="controls">
      <label htmlFor="guid-39047411" className="control__label">
