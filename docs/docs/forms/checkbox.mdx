...
<div className="d-example">
  <div className="form__group form-checkbox">
    <label for="checkbox-1" className="control__label">My label</label>
...
<div className="d-example">
  <div className="form__group form-checkbox">
    <label for="checkbox-2" className="control__label">My label</label>
    <div className="controls">
...
<div className="d-example">
  <div className="form__group form-checkbox-inline">
    <div className="controls">
      <label for="checkbox-5" className="control__label">
  ...
  <div className="form__group form-checkbox-inline form__group--indent">
    <div className="controls">
      <label for="checkbox-6" className="control__label">
