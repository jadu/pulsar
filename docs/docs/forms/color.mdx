...
<div className="d-example">
  <div className="form__group colorpicker js-colorpicker">
    <label htmlFor="color-a1" className="control__label">Pick colour</label>
...
<div className="d-example">
  <div className="form__group colorpicker js-colorpicker">
    <label htmlFor="color-a2" className="control__label">Pick colour</label>
    <div className="controls">
      <div className="input-group">
        <span className="input-group-addon">#</span>
        <input id="color-a2" disabled type="text" className="form__control is-disabled" />
      </div>
    </div>
  </div>
</div>
